...
/// Build array consist of HiSysEventParamValue with different type except
/// string.
#[macro_export]
...
macro_rules! build_param_value {
    ($param_type:expr, $val:expr) => {
        match $param_type as &str {
            "i8" => hisysevent::HiSysEventParamValue { i8_: $val as i8 },
            "u8" => hisysevent::HiSysEventParamValue { u8_: $val as u8 },
            "i16" => hisysevent::HiSysEventParamValue { i16_: $val as i16 },
            "u16" => hisysevent::HiSysEventParamValue { u16_: $val as u16 },
            "i32" => hisysevent::HiSysEventParamValue { i32_: $val as i32 },
            "u32" => hisysevent::HiSysEventParamValue { u32_: $val as u32 },
            "i64" => hisysevent::HiSysEventParamValue { i64_: $val as i64 },
            "u64" => hisysevent::HiSysEventParamValue { u64_: $val as u64 },
            "f32" => hisysevent::HiSysEventParamValue { f32_: $val as f32 },
            "f64" => hisysevent::HiSysEventParamValue { f64_: $val as f64 },
            _ => hisysevent::HiSysEventParamValue { b_: false },
        }
    };
}
...
macro_rules! build_bool_param {
    ($param_name_:expr, $param_value:expr) => {{
        ...
        hisysevent::HiSysEventParam {
            ...
            param_value: hisysevent::HiSysEventParamValue { b_: $param_value },
            array_size: param_len,
        }
    }};
}
