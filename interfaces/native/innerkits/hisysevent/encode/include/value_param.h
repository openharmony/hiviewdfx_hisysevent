...
#ifndef HISYSEVENT_INTERFACE_ENCODE_INCLUDE_VALUE_PARAM_H
#define HISYSEVENT_INTERFACE_ENCODE_INCLUDE_VALUE_PARAM_H
...
#endif // HISYSEVENT_INTERFACE_ENCODE_INCLUDE_VALUE_PARAM_H