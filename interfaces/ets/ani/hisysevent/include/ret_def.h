...
#ifndef ANI_HISYSEVENT_RET_DEF_H
#define ANI_HISYSEVENT_RET_DEF_H
...
static constexpr int32_t ANI_SUCCESS = 0;

static constexpr int32_t ERR_INVALID_PARAM_COUNT = -100;
static constexpr int32_t ERR_ANI_PARSED_FAILED = -101;
...
static constexpr int32_t ERR_ANI_LISTENER_NOT_FOUND = -107;
} // namespace HiviewDFX
} // namespace OHOS
